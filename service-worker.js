...
const cachedFiles = [
  ...
  "./src/landing-tabs.js",
  "./src/landing-auth.js",
  "./src/pwa-register.js?v=47",
  "./app.js?v=47",
  "./manifest.webmanifest?v=34",
  "./icon.svg?v=34",
  "./assets/logo-oenaris.svg?v=34",
  "./assets/logo-oenaris-horizontal.svg?v=34",
  "./assets/logo-oenaris-icon.svg?v=34",
  "./assets/oenaris-dashboard-hero-bg.jpg",
  "./assets/oenaris-sidebar-bg.jpg",
  "./assets/icon-bottle-premium.png",
  "./assets/icon-buy.png",
  "./assets/icon-coins.png",
  "./assets/icon-drink.png",
  "./assets/icon-glass.png",
  "./assets/icon-grape.png",
  "./assets/icon-low-stock.png",
  "./assets/wine-action-panel-bg.webp",
  "./assets/wine-card-shell-bg.webp",
  "./assets/wine-landscape-divider.webp",
  "./assets/wine-note-panel-bg.webp",
  "./assets/wine-photo-frame-bg.webp"
];
...
const networkFirstUrls = new Set([
  ...
  new URL("./privacy.html", self.location.href).pathname,
  new URL("./terms.html", self.location.href).pathname,
  new URL("./legal.html", self.location.href).pathname,
  new URL("./data-deletion.html", self.location.href).pathname,
